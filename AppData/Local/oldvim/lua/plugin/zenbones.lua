            ...
            local specs =
                ...
                function()
                    return {
                        ...
                        RainbowRose {zenbones.Normal, fg=palette.rose.sa(30).da(5)},
                        RainbowWood {zenbones.Normal, fg=palette.wood.sa(30).da(5)},
                        RainbowWater {zenbones.Normal, fg=palette.water.sa(30).da(5)},
                        RainbowLeaf {zenbones.Normal, fg=palette.leaf.sa(30).da(5)},
                        RainbowBlossom {zenbones.Normal, fg=palette.blossom.sa(30).da(5)},
                        RainbowSky {zenbones.Normal, fg=palette.sky.sa(30).da(5)},
                    }
                end
            )
